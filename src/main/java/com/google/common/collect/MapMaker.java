...
// TODO: Monkey patched because maven-plugin-testing-harness pulls in (and requires) an ancient version of Guava
// which relies on the deprecated (and now package access) method makeComputingMap.
